                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                if ($value->status_pengajuan == '0') {
                                                    ?>
                                                    <div class="btn-group">
                                                        <a href="<?= base_url('Admin/cKelolaData/deletebarang/' . $value->id_pengajuan) ?>"
                                                            class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                                        <button type="button" data-toggle="modal"
                                                            data-target="#keputusan<?= $value->id_pengajuan ?>"
                                                    ...
                                                    ?>
                                                        <button type="button" data-toggle="modal"
                                                            data-target="#asset<?= $value->id_pengajuan ?>"
                                                            class="btn btn-warning"><i class="fas fa-edit"></i></button>
...
foreach ($pengajuan as $key => $value) {
    ...
    <div class="modal fade" id="keputusan<?= $value->id_pengajuan ?>">
        <div class="modal-dialog">
            <form action="<?= base_url('User/ckeputusan/keputusan/' . $value->id_pengajuan) ?>" method="POST">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Apakah User Mengkonfirmasi Pengajuan?</p>
...
foreach ($pengajuan as $key => $value) {
    ...
    <div class="modal fade" id="asset<?= $value->id_pengajuan ?>">
        <div class="modal-dialog">
            <form action="<?= base_url('User/ckeputusan/asset_keputusan/' . $value->id_pengajuan) ?>" method="POST">
                <div class="modal-content">
                    <div class="modal-header">
