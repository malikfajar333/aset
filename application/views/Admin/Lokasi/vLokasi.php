                                    ...
                                    foreach ($lokasi as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="<?= base_url('Admin/cKelolaData/deletelokasi/' . $value->id_lokasi) ?>"
                                                        class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                                    <button type="button" data-toggle="modal"
                                                        data-target="#edit<?= $value->id_lokasi ?>"
            ...
            <form action="<?= base_url('admin/ckeloladata/updatelokasi/' . $value->id_lokasi) ?>" method="POST">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nama Lokasi</label>
                            <input type="text" name="nama" value="<?= $value->nama_lokasi ?>" class="form-control"
                                id="exampleInputEmail1" placeholder="Nama Lokasi" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Alamat Lengkap</label>
                            <textarea name="alamat" class="form-control" placeholder="Alamat Lengkap"
                                required><?= $value->alamat_lengkap ?></textarea>
                        </div>
                    </div>
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
