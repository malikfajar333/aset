                                    ...
                                    foreach ($monitoring as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><img width="150px"
                                                    src="<?= base_url('asset/asset-monitoring/' . $value->gambar_asset_monitoring) ?>">
                                            </td>
                                            <td><?= $value->faktor_penyebab ?></td>
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="<?= base_url('Admin/cMonitoring/delete/' . $value->id_monitoring) ?>"
                                                        class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                                    <a href="<?= base_url('Admin/cMonitoring/edit/' . $value->id_monitoring) ?>"
