                                    ...
                                    foreach ($asset as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><img width="150px"
                                                    src="<?= base_url('asset/images/' . $value->kode_asset . '.png') ?>"><br>
                                                <strong><?= $value->kode_asset ?></strong>
                                            </td>
                                            <td class="text-center"><img width="150px"
                                                    src="<?= base_url('asset/foto-asset/' . $value->gambar_asset) ?>"></td>
                                            <td><?= $value->nama_barang ?></td>
                                            <td><?= $value->merk ?></td>
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="<?= base_url('Admin/cAsset/delete/' . $value->id_asset) ?>"
                                                        class="btn btn-danger"><i class="fas fa-trash"></i></a>
                                                    <a href="<?= base_url('Admin/cAsset/edit/' . $value->id_asset) ?>"
                                                        class="btn btn-warning"><i class="fas fa-edit"></i></a>

                                                    <button type="button" data-toggle="modal"
                                                        data-target="#detail<?= $value->id_asset ?>"
                                                        class="btn btn-primary"><i class="fas fa-th-list"></i></button>
