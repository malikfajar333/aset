                    ...
                    <div class="card card-danger">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="kode" value="<?= $asset->kode_asset ?>" class="form-control"
                                    id="exampleInputPassword1" placeholder="Kode Asset">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="merk" value="<?= $asset->merk ?>" class="form-control"
                                    id="exampleInputPassword1" placeholder="Merk Asset">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tgl" value="<?= $asset->tgl_peroleh ?>"
                                            class="form-control" id="exampleInputPassword1" placeholder="Kode Asset">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="harga" value="<?= $asset->harga_asset ?>"
                                            class="form-control" id="exampleInputPassword1" placeholder="Harga Asset">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="jml" class="form-control"
                                            value="<?= $asset->jml_asset ?>" id="exampleInputPassword1"
                            ...
                            <div class="row">
                                <div class="col-lg-6"><img width="300px"
                                        src="<?= base_url('asset/foto-asset/' . $asset->gambar_asset) ?>"></div>
                                <div class="col-lg-6">
                                    <div class="form-group">
