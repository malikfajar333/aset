            ...
            <div class="row">
                <div class="col-8">
                    <button type="button" class="btn btn-default mb-3" data-toggle="modal" data-target="#modal-default">
                        <i class="fas fa-th-list"></i> Tambah Data Kategori
                    </button>
                    <div class="card">
                                    ...
                                    foreach ($kategori as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a href="<?= base_url('Admin/cKelolaData/deletekategori/' . $value->id_kategori) ?>"
            ...
            <form action="<?= base_url('admin/ckeloladata/updatekategori/' . $value->id_kategori) ?>" method="POST">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nama Kategori</label>
                            <input type="text" name="nama" value="<?= $value->nama_kategori ?>" class="form-control"
